...
@dso_cache = dso_local local_unnamed_addr global [576 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1418572020, ; hash 0x548db0f4, from name: app_impresora.dll.so
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1840021591, ; hash 0x6dac8057, from name: libaot-app_impresora
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-app_impresora.dll.so
		ptr null; void* handle (0x0)
	}, ; 233
	...
	%struct.DSOCacheEntry {
		i64 2921050687, ; hash 0xae1bb23f, from name: aot-app_impresora
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-app_impresora.dll.so
		ptr null; void* handle (0x0)
	}, ; 397
	...
	%struct.DSOCacheEntry {
		i64 3215883813, ; hash 0xbfae7e25, from name: app_impresora
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-app_impresora.dll.so
		ptr null; void* handle (0x0)
	}, ; 442
	...
	%struct.DSOCacheEntry {
		i64 3282453236, ; hash 0xc3a642f4, from name: aot-app_impresora.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-app_impresora.dll.so
		ptr null; void* handle (0x0)
	}, ; 454
	...
	%struct.DSOCacheEntry {
		i64 3398355765, ; hash 0xca8ecb35, from name: libaot-app_impresora.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-app_impresora.dll.so
		ptr null; void* handle (0x0)
	}, ; 466
